...
const Under120 = require('../models/under120.model') // Import the model
...
router.route('/add').post((req, res) => { // Post: Client wants to send data
  ...
  const newComment = new Under120({ username, comment }); // Creates a document using Under120's document model format
